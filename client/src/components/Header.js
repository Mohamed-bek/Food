...
const Header = () => {
  ...
  return (
    <div className="boncDown -translate-y-full bg-primary MainHeder relative flex justify-around items-center w-full h-[70px] border-b-[2px] z-50 border-solid border-secondary">
      <nav
        ref={CardRef}
        className="fixed duration-500 overflow-y-auto text-primary min-h-[100vh] top-0 py-7 right-0  bg-[#383636f1] w-full md:w-[600px] z-[999999999] translate-x-full"
      >
        <h1 className="px-4 py-1 text-primary text-[4.5rem] w-fit mx-auto">
          Orders
        </h1>
      ...
      <span className="flex items-center gap-5">
        <span className="fixed maxz top-5 right-7">
